...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link Directive} or {@link com.jamitlabs.alexaconnect.libraries.alexa.data.Event} URL
    ...
    /**
     * Get our JSON {@link com.jamitlabs.alexaconnect.libraries.alexa.data.Event} for this call
     * @return the JSON representation of the {@link com.jamitlabs.alexaconnect.libraries.alexa.data.Event}
     */
    @NotNull
