package com.jamitlabs.alexaconnect.libraries.alexa;
...
import com.jamitlabs.alexaconnect.libraries.alexa.utility.Util;
...
public class AuthorizationManager {
    ...
    public void authorizeUser(AuthorizationCallback callback){
        mCallback = callback;
         ...
         String  productID = "voice_enabled_resturant_app" ;// spell check
         String productDSN = "12345";

        String PRODUCT_DSN = Settings.Secure.getString(mContext.getContentResolver(),
                Settings.Secure.ANDROID_ID);

        Bundle options = new Bundle();
        String scope_data = "{\"alexa:all\":{\"productID\":\"" + productID +
